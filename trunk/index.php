...
if(plugin_connections_haveRight("connections","r") || haveRight("config","w"))
{
	manageGetValuesInSearch(PLUGIN_CONNECTIONS_TYPE);
	
	searchForm(PLUGIN_CONNECTIONS_TYPE,$_GET);

	showList(PLUGIN_CONNECTIONS_TYPE,$_GET);
