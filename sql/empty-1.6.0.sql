...
CREATE TABLE `glpi_plugin_connections_connections` (
   ...
   KEY `plugin_connections_connectionratesguaranteed_id` (`plugin_connections_connectionratesguaranteed_id`),
...
DROP TABLE IF EXISTS `glpi_plugin_connections_connectionratesguaranteed`;
CREATE TABLE `glpi_plugin_connections_connectionratesguaranteed` (
   `id` int(11) NOT NULL auto_increment,
   `entities_id` int(11) NOT NULL default '0',
   `name` varchar(255) collate utf8_unicode_ci default NULL,
   `comment` text collate utf8_unicode_ci,
