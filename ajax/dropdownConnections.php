...
$where  = " WHERE (`plugin_connections_connectiontypes_id` = '".$_POST['plugin_connections_connectiontypes_id']."') 
				 AND `is_deleted` = '0'";
$where .= getEntitiesRestrictRequest("AND","glpi_plugin_connections_connections",'',$entity_restrict,true);
